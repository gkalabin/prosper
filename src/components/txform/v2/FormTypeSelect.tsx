import {FormType} from '@/components/txform/v2/types';
    ...
    <div className="col-span-6 flex justify-center">
      <div className="rounded-md shadow-sm">
        <Button
          ...
          onClick={() => setValue(FormType.EXPENSE)}
          active={value == FormType.EXPENSE}
          disabled={disabled}
        >
          Expense
        </Button>
        <Button
          ...
          onClick={() => setValue(FormType.TRANSFER)}
          active={value == FormType.TRANSFER}
          disabled={disabled}
        >
          Transfer
        </Button>
        <Button
          ...
          onClick={() => setValue(FormType.INCOME)}
          active={value == FormType.INCOME}
          disabled={disabled}
        >
          Income
        </Button>
