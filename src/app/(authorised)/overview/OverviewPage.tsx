'use client';
import {BankAccountListItem} from '@/app/(authorised)/overview/AccountListItem';
import {accountsSum} from '@/app/(authorised)/overview/modelHelpers';
import {OpenBankingConnectionExpirationWarning} from '@/app/(authorised)/overview/OpenBankingConnectionExpirationWarning';
import {StatsWidget} from '@/app/(authorised)/overview/StatsWidget';
import {
  isFullyConfigured,
  NotConfiguredYet,
