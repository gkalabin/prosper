...
test.describe('Statistics', () => {
  test.describe('Expense Statistics', () => {
    test('displays monthly expense chart', async () => {
      // TODO: Create user with expenses across multiple months via seed
      // TODO: Log in
      // TODO: Navigate to expense statistics page
      // TODO: Verify monthly chart is rendered
      // TODO: Verify amounts are converted to display currency
    });
