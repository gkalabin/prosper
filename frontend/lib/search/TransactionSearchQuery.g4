// To generate the lexer and parser, run the following command from the repo root:
// antlr4 -Dlanguage=TypeScript -no-listener -visitor -Werror -Xexact-output-dir -o frontend/lib/search/generated frontend/lib/search/TransactionSearchQuery.g4
