import {CountriesSelector} from '@/app/(authenticated)/config/open-banking/gocardless/institutions/CountriesSelector';
import {InstitutionSelector} from '@/app/(authenticated)/config/open-banking/gocardless/institutions/InstitutionSelector';
